...
import com.example.todoapp.data.TodosQueryHandler;
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     //   updateToDo();
       ...
       // CreateCategory();
        ...
        adapter=new TodosCursorAdapter(this,
                cursor,false);
    ...
    private void CreateTestTodo(){
        for(int i=1;i<=20;i++){
            ...
            TodosQueryHandler handler=
                    new TodosQueryHandler(this.getContentResolver());
...
private void CreateCategory(){
    ...
    private void deleteToDo(int id){
        ...
        TodosQueryHandler handler=
                new TodosQueryHandler(this.getContentResolver());
        handler.startDelete(1,null,TodosEntry.CONTENT_URI,
                TodosEntry._ID+ "=?", args);
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        ...
        return new CursorLoader(this, TodosEntry.CONTENT_URI,
